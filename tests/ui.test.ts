...
check('le visuel du jour porte les infos, dessus', ticketVide.includes('data-visuel="jour"') && ['data-hero-noms', 'data-hero-heure', 'data-hero-compte', 'data-hero-total'].every((a) => ticketVide.includes(a)), true);
check(
