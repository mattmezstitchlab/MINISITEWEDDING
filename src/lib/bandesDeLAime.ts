...
export const LA_BARRE = {
  ...
  pastille: { mot: 'Ouvrir le ticket', vers: '#le-ticket-plein' },
};
...
export const LE_TITRE = {
  ...
  /* Tout est déjà écrit sur le papier, en haut de la page : la phrase ne fait
     que le dire — et l'appli, c'est le ticket lui-même. */
  sous: 'C’est le ticket, plein écran : on le scrolle, on coche les lignes — elles passent au fluo — et l’on tamponne. Ce qui est coché part dans les portefeuilles : le couple, les invités, la famille, le DJ, les métiers.',
  pastilles: [
    { mot: 'Ouvrir le ticket', vers: '#le-ticket-plein', fort: true },
...
export const LE_PIED = {
  ...
  filet: 'SUPER MARIAGE',
  liens: [
    { mot: 'Le ticket', vers: '#le-ticket-plein' },
    { mot: 'L’appareil', vers: '#l-appareil' },
