...
export default function PublicSite() {
  ...
  if (notFound || !site) {
    return (
      <div className="min-h-screen bg-[#FAF8F5] flex flex-col items-center justify-center gap-4 px-6 text-center" style={{ fontFamily: '"Fraunces", Georgia, serif' }}>
        <Heart size={36} strokeWidth={1.25} className="text-neutral-300" />
        <h1 className="text-2xl sm:text-3xl font-medium tracking-tight" style={{ fontFamily: '"Fraunces", Georgia, serif' }}>Ce site n’existe pas encore.</h1>
