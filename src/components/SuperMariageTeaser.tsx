...
export default function SuperMariageTeaser() {
  ...
  return (
    <section className="bg-[#0A0A0A] px-5 py-16 text-white sm:px-8">
      <div className="mx-auto grid max-w-[1180px] gap-10 lg:grid-cols-[minmax(0,1fr)_380px] lg:items-center">
        <div>
          <span
