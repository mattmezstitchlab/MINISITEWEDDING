...
export default function SharePanel({ site, onPublishedChange }: Props) {
  ...
  return (
    <div className="text-center">
      ...
      <h3 className="mt-4 text-2xl font-medium tracking-tight" style={{ fontFamily: '"Wix Madefor Display", "Plus Jakarta Sans", system-ui, sans-serif' }}>Votre site est prêt.</h3>
      ...
      <div className="mt-6 p-5 rounded-2xl bg-white border border-black/10">
        ...
        <div className="mt-2 text-xl font-medium tabular-nums break-all tracking-tight" style={{ fontFamily: '"Wix Madefor Display", "Plus Jakarta Sans", system-ui, sans-serif' }}>{url}</div>
