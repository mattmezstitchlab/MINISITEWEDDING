...
export default function PredictiveOrchestrationStudio() {
  ...
  const applyDelay = (delayDeltaMinutes: number) => {
    ...
    const { shiftedMoments, cascadeEvents } = calculateCascadeShift(
      moments,
      'm3', // On simule un décalage typique sur le Dîner / Service traiteur
      nextShift
    );
  ...
  return (
    <div className="relative overflow-hidden rounded-[34px] border border-white/10 bg-[#0C0D14] p-5 sm:p-8 text-white shadow-2xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-6">
        ...
        {/* Commandes du simulateur de retard */}
      ...
      {/* Jauge d'état globale de la timeline */}
      ...
      {/* Grille des moments synchronisés en cascade */}
      <div className="mt-6 grid grid-cols-1 md:grid-cols-5 gap-3">
        {moments.map((m, idx) => {
          ...
          return (
            ...
            >
              {/* Entête du moment avec heure recalculée */}
      ...
      {/* Journal des cascades algorithmiques en direct */}
