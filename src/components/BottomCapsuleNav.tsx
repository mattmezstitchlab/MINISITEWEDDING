...
import { Heart, Home, Layers, Music2, Smartphone } from 'lucide-react';
 ...
 * mène à la page qui porte la section. On navigue pareil partout, sans
 * réapprendre la barre à chaque page.
 */
