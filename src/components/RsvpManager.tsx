  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-5">
        <div>
          <h3 className="text-xl font-medium tracking-tight" style={{ fontFamily: '"Space Grotesk", "Hanken Grotesk", sans-serif' }}>Réponses des invités</h3>
      ...
      <div className="grid grid-cols-2 gap-2.5">
        {stats.map((s) => (
          <div key={s.label} className={`p-4 rounded-2xl ${s.bg}`}>
            ...
            <div className="mt-2 text-xl font-semibold tabular-nums tracking-tight" style={{ fontFamily: '"Space Grotesk", "Hanken Grotesk", sans-serif' }}>{s.value}</div>
