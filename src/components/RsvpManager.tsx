  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-5">
        <div>
          <h3 className="text-xl font-light" style={{ fontFamily: '"Playfair Display", "Cormorant Garamond", Georgia, serif' }}>Réponses des invités</h3>
      ...
      <div className="grid grid-cols-2 gap-2.5">
        {stats.map((s) => (
          <div key={s.label} className={`p-4 rounded-2xl ${s.bg}`}>
            ...
            <div className="mt-2 text-xl font-medium tabular-nums" style={{ fontFamily: '"Playfair Display", "Cormorant Garamond", Georgia, serif' }}>{s.value}</div>
